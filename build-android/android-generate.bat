...
mkdir  core_validation device_limits image object_tracker parameter_validation swapchain threading unique_objects api_dump
cd ..\..
xcopy /s gradle-templates\*   generated\gradle-build\
for %%G in (core_validation device_limits image parameter_validation swapchain threading api_dump) Do (
