...
#include "cube.vert.inc"
    ...
    demo->vert_shader_module = demo_prepare_shader_module(demo, vs_code, 4 * ARRAY_SIZE(vs_code));
}
...
#include "cube.frag.inc"
    ...
    demo->frag_shader_module = demo_prepare_shader_module(demo, fs_code, 4 * ARRAY_SIZE(fs_code));
}
