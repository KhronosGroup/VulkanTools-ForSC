...
#include "cube.frag.inc"
        ...
        frag_shader_module = prepare_shader_module(fragShaderCode, 4 * ARRAY_SIZE(fragShaderCode));
...
#include "cube.vert.inc"
        ...
        vert_shader_module = prepare_shader_module(vertShaderCode, 4 * ARRAY_SIZE(vertShaderCode));
