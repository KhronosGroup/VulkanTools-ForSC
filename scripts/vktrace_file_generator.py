...
class VkTraceFileOutputGenerator(OutputGenerator):
    ...
    def GenerateTraceVkPacketsHeader(self):
        ...
        trace_pkt_hdr += '\n'
        trace_pkt_hdr += '// Every module that includes vktrace_vk_vk_packets.h needs to define\n'
        trace_pkt_hdr += '// vkreplay_interpret_pnext_handles. Most of the time it is a stub - only\n'
        trace_pkt_hdr += '// vkreplay needs to implement it.\n'
        trace_pkt_hdr += 'extern void vkreplay_interpret_pnext_handles(void *struct_ptr);\n'
