    ...
    : QGroupBox(tr("Active Layers"), parent)
{
    ...
    QPushButton *remove_button_arrow = new QPushButton();
    remove_button_arrow->setObjectName("RemoveButton2");
    remove_button_arrow->setToolTip(tr("Remove selected"));
    remove_button_arrow->setIcon(QApplication::style()->standardIcon(QStyle::SP_ArrowRight));
    right_column_layout->addWidget(remove_button_arrow, 2, 0);
    connect(remove_button_arrow, &QPushButton::clicked, this, &ActiveLayersWidget::removeSelectedLayer);
