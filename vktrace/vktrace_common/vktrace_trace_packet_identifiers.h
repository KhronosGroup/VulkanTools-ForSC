...
typedef enum _VKTRACE_TRACE_PACKET_ID_VK {
    ...
    VKTRACE_TPI_VK_vkGetDeviceGroupPeerMemoryFeaturesKHX = 209,             // Deprecated
    VKTRACE_TPI_VK_vkBindBufferMemory2KHR = 210,
    VKTRACE_TPI_VK_vkBindImageMemory2KHR = 211,
    VKTRACE_TPI_VK_vkCmdSetDeviceMaskKHX = 212,                             // Deprecated
    VKTRACE_TPI_VK_vkGetDeviceGroupPresentCapabilitiesKHX = 213,            // Deprecated
    VKTRACE_TPI_VK_vkGetDeviceGroupSurfacePresentModesKHX = 214,            // Deprecated
    VKTRACE_TPI_VK_vkAcquireNextImage2KHX = 215,                            // Deprecated
    VKTRACE_TPI_VK_vkCmdDispatchBaseKHX = 216,                              // Deprecated
    VKTRACE_TPI_VK_vkGetPhysicalDevicePresentRectanglesKHX = 217,           // Deprecated
    VKTRACE_TPI_VK_vkEnumeratePhysicalDeviceGroupsKHX = 218,                // Deprecated
    VKTRACE_TPI_VK_vkCmdProcessCommandsNVX = 219,                           // Deprecated
    VKTRACE_TPI_VK_vkCmdReserveSpaceForCommandsNVX = 220,                   // Deprecated
    VKTRACE_TPI_VK_vkCreateIndirectCommandsLayoutNV = 221,
    VKTRACE_TPI_VK_vkDestroyIndirectCommandsLayoutNV = 222,
    VKTRACE_TPI_VK_vkCreateObjectTableNVX = 223,                            // Deprecated
    VKTRACE_TPI_VK_vkDestroyObjectTableNVX = 224,                           // Deprecated
    VKTRACE_TPI_VK_vkRegisterObjectsNVX = 225,                              // Deprecated
    VKTRACE_TPI_VK_vkUnregisterObjectsNVX = 226,                            // Deprecated
    VKTRACE_TPI_VK_vkGetPhysicalDeviceGeneratedCommandsPropertiesNVX = 227, // Deprecated
    ...
    VKTRACE_TPI_VK_vkCreateDeferredOperationKHR = 309,
    VKTRACE_TPI_VK_vkDestroyDeferredOperationKHR = 310,
    VKTRACE_TPI_VK_vkGetDeferredOperationMaxConcurrencyKHR = 311,
    VKTRACE_TPI_VK_vkGetDeferredOperationResultKHR = 312,
    VKTRACE_TPI_VK_vkDeferredOperationJoinKHR = 313,
    VKTRACE_TPI_VK_vkCreateAccelerationStructureKHR = 314,
    VKTRACE_TPI_VK_vkGetAccelerationStructureMemoryRequirementsKHR = 315,
    VKTRACE_TPI_VK_vkCmdBuildAccelerationStructureKHR = 316,
    VKTRACE_TPI_VK_vkCmdBuildAccelerationStructureIndirectKHR = 317,
    VKTRACE_TPI_VK_vkBuildAccelerationStructureKHR = 318,
    VKTRACE_TPI_VK_vkCopyAccelerationStructureKHR = 319,
    VKTRACE_TPI_VK_vkCopyAccelerationStructureToMemoryKHR = 320,
    VKTRACE_TPI_VK_vkCopyMemoryToAccelerationStructureKHR = 321,
    VKTRACE_TPI_VK_vkWriteAccelerationStructuresPropertiesKHR = 322,
    VKTRACE_TPI_VK_vkCmdCopyAccelerationStructureKHR = 323,
    VKTRACE_TPI_VK_vkCmdCopyAccelerationStructureToMemoryKHR = 324,
    VKTRACE_TPI_VK_vkCmdCopyMemoryToAccelerationStructureKHR = 325,
    VKTRACE_TPI_VK_vkCmdTraceRaysKHR = 326,
    VKTRACE_TPI_VK_vkCreateRayTracingPipelinesKHR = 327,
    VKTRACE_TPI_VK_vkGetAccelerationStructureDeviceAddressKHR = 328,
